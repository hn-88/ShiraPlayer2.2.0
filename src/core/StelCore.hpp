...
#include "freehand/freehanditem.hpp"
...
public:
    //ASAF
    bool flagTuiDatetime;
    bool flagTuiLocation;
    bool show_only_this_datetime;
    bool show_only_this_location;
    QImage texture;
    ...
    //FPS yi g�stermek i�in
    void displayFramerate();
    bool showFPS;
    void setShowFPS(int value);

    //Unregistred show
    void unregisteredShow();
    StelTextureSP texLogo;
    QElapsedTimer timerLogo;
    QTimeLine* logoFader;
    float logoRotation;
    float xLogo;
    float yLogo;
    ...
    //Free draw
    void drawPaintFree();
    QVector<freehandItemPtr> freehandItems;
    QVector<freehandItemPtr> freehandPrevScreenItems;
    QPointF oldPathPos;
    QPointF oldPathPosPrevScreen;
    QPainterPath path;
    QPainterPath pathPrevScreen;
    QPen freeHandPen;
    int freeHandSize;
    double freeHandOpacity;
    bool prevScreendrawing;
    //
    bool isConnectedFromTablet;
    bool isConnectedFromTabletFreeVersion;
...
public slots:
    ...
    void setFlipHorz(bool flip)
    {
        ...
        StelApp::getInstance().addNetworkCommand("core.setFlipHorz("+ QString("%0").arg(flip) +");");
    }
    ...
    void setFlipVert(bool flip)
    {
        ...
        StelApp::getInstance().addNetworkCommand("core.setFlipVert("+ QString("%0").arg(flip) +");");
    }
...
public://ASAF
    ...
    int screen_h;
    int screen_l;
    LinearFader ALLFader;
    Vec3f allFaderColor;

    bool m_birdefa;

    QFont m_overlayFont;
    bool showchannel_name;

    QFont datestring_font;
    QFont m_FPSFont;
    QFont m_Unlicensedfont;
