...
void StelFileMgr::init()
{
    ...
    {
        userDir = winApiPath + "\\ShiraPlayer";
    }
#elif defined(Q_OS_MAC)
    userDir = QDir::homePath() + "/Library/Application Support/ShiraPlayer";
#else
    userDir = QDir::homePath() + "/.shiraplayer";
#endif
...
QString StelFileMgr::getWin32SpecialDirPath(int csidlId)
{
    ...
    // ShiraPlayer works only on wide-character versions of Windows anyway,
