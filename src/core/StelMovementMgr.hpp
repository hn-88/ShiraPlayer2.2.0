...
public:
    ...
    void setFrontViewDirection(QString direction, double trackTime);

    bool getflagAutoMove() { return flagAutoMove;}
    //ASAF
    double fov_changed;
    double rec_deltaAz;
    double rec_deltaAlt;

    QString frontDirection;
public slots:
    ...
    void moveToAltAz(const Vec3d& target);
