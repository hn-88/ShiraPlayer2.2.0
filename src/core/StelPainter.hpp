...
public:
    ...
    void sSphere2(float radius, float oneMinusOblateness, int slices, int stacks, bool flipTexture = false, double elipsisrate = 1.0);
    ...
    void sCylinder2(float radius, float height, int slices, int orientInside = 0);
    ...
    void DrawStrokePath(float x1, float y1, float x2, float y2);
    void DrawStrokePath(QPainterPath _path,QPen _pen,int _size,double _opacity);
