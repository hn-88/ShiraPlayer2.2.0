...
public:
    ...
    //Yeni distort iþlemi ile iptal edildi
//#ifndef SHIRAPLAYER_PRE
//    SphericalRegionP getViewportConvexPolygon(float marginX=300., float marginY=300.) const; //ASAF marginX=300.0 marginY=300.0( her ikiside 0. dý.Takým Yýldýzlar geçiþlerde görünmesi için deðiþtirildi)
//#else
...
//#endif
    ...
    inline bool projectInPlace(Vec3d& v) const
    {
        ...
        //Yeni distort - blend iþlemi ile iptal edildi
        //#else
        //                v[0] = viewportCenter[0] + flipHorz * pixelPerRad * v[0]*StelApp::getInstance().fov_width_rate; //ASAF
        //                v[1] = viewportCenter[1] + flipVert * pixelPerRad * v[1]*StelApp::getInstance().fov_height_rate; //ASAF
        //#endif
    ...
    float getVievportFovDiameter(){return viewportFovDiameter;}
    bool getFlaghasDiscontinuity(){return hasDiscontinuity();}
protected:
