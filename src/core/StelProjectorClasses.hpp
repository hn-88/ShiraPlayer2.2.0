...
public:
    ...
    virtual void project(int n, const Vec3d* in, Vec3f* out)
    {
        ...
        for (int i = 0; i < n; ++i)
        {
            ...
            //ASAF fov_width_rate,fov_height_rate çarpan olarak ekledim (0.1 ile 1 arasý olabilecek deðerler)
            ...
            //#else
            //                        out[i][0] = viewportCenter[0] + flipHorz * pixelPerRad * v[0]*StelApp::getInstance().fov_width_rate;
            //                        out[i][1] = viewportCenter[1] + flipVert * pixelPerRad * v[1]*StelApp::getInstance().fov_height_rate;
            //#endif
