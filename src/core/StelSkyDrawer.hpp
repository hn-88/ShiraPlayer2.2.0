...
public:
    ...
    void postDrawSky3dModelAtm(StelPainter* sPainter, const Vec3d& v, float illuminatedArea, float mag, const Vec3f& color = Vec3f(1.f,1.f,1.f));
    bool drawPointSourceAtm(StelPainter* sPainter,const Vec3d& v, const float rcMag[2], const Vec3f& color, bool checkInScreen=false);
    void postDrawPointSourceAtm(StelPainter* sPainter);
    //
public slots:
    //! Set the way brighter stars will look bigger as the fainter ones
    void setRelativeStarScale(double b=1.0) {
        starRelativeScale=b;
        StelApp::getInstance().addNetworkCommand("StelSkyDrawer.setRelativeStarScale("+ QString("%0").arg(b) +");");
    }
    ...
    void setAbsoluteStarScale(double b=1.0)
    {
        ...
        StelApp::getInstance().addNetworkCommand("StelSkyDrawer.setAbsoluteStarScale("+ QString("%0").arg(b) +");");
    }
    ...
    void setTwinkleAmount(double b) {
        twinkleAmount=b;
        StelApp::getInstance().addNetworkCommand("StelSkyDrawer.setTwinkleAmount("+ QString("%0").arg(b) +");");
    }
    ...
    {
        flagStarTwinkle=b;
        StelApp::getInstance().addNetworkCommand("StelSkyDrawer.setFlagTwinkle("+ QString("%0").arg(b) +");");
    }
    ...
    void setFlagLuminanceAdaptation(bool b) {
        ...
        StelApp::getInstance().addNetworkCommand("StelSkyDrawer.setFlagLuminanceAdaptation("+ QString("%0").arg(b) +");");
    }
...
private:
    ...
    //Asaf- atmosphere
    StelTextureSP texFlyByAtmosphere;
