...
public:
    ...
    QString insertSkyLayer(StelSkyLayerP l, const QString& keyHint=QString(), bool show=true,bool JA=false);
...
public slots:
    ...
    //! @param j2000 or AltAzm J,A //ASAF
...
private:
    ...
    {
    public:
        SkyLayerElem(StelSkyLayerP t, bool show=true ,bool JA=false);
        ~SkyLayerElem();
        StelSkyLayerP layer;
