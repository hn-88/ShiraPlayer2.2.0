...
//#include "previewutil/PrevPainter.hpp"
...
//void StelVertexArray::draw(PrevPainter* painter) const
//{
//        painter->setVertexPointer(3, GL_DOUBLE, vertex.constData());
//        if (isTextured())
//        {
...
//        }
//        if (isIndexed())
//                painter->drawFromArray((PrevPainter::DrawingMode)primitiveType, indices.size(), 0, true, indices.constData());
//        else
//                painter->drawFromArray((PrevPainter::DrawingMode)primitiveType, vertex.size());
//
//        painter->enableClientStates(false);
//}
