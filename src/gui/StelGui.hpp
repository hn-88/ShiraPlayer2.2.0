...
public:
    ...
    //ASAF
    void writeSettingDlg();
    void readSettingDlg();

    void startAutoSave(bool status);
public slots:
...
#endif
    //ASAF
    servermanager servermanagerDialog;
    recordmanager recordmanagerDialog;
    //PreviewDialog* previewManager;
private:
...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "shiraplayer.StelGuiPluginInterface/1.0")
