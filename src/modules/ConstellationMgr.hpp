...
public slots:
    ...
    {
        isolateSelected = s;
        StelApp::getInstance().addNetworkCommand("ConstellationMgr.setFlagIsolateSelected("+QString("%0").arg(s)+");");
    }
    ...
    void setLinesWidth(const int w);
    ...
    //ASAF
    void ShowHideArt(QString name,bool sh);
    QStringList GetAllNameI18n();
    QStringList GetAllNames();
    QStringList GetAllShortNames();
    void ShowHideZodiac(bool sh, bool line, bool isname);
    void ShowSummerConst(bool sh, bool line, bool isname);
    void ShowSpringConst(bool sh, bool line, bool isname);
    void ShowAutumnConst(bool sh, bool line, bool isname);
    void ShowWinterConst(bool sh, bool line, bool isname);
    void ShowAllConst(bool sh, bool line, bool isname);
    void ShowSelectedLabels(bool sh);
    void clearAllConst();
    //
private:
...
public:
    ...
    //! Handle unselecting a single constellation.
    void unsetSelectedConstWithoutAll(Constellation* c);
    ...
    QStringList SummerList;
    QStringList WinterList;
    QStringList SpringList;
    QStringList AutumnList;
