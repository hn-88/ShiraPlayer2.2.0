...
public:
    ...
    virtual void update(double deltaTime) {
        ...
        starsFader.update((int)(deltaTime*1000));
...
public slots:
    ...
    {
        starsFader=b;
        StelApp::getInstance().addNetworkCommand("StarMgr.setFlagStars("+QString("%0").arg(b)+");");
    }
    ...
    {
        labelsFader=b;
        StelApp::getInstance().addNetworkCommand("StarMgr.setFlagLabels("+QString("%0").arg(b)+");");
    }
    ...
    void setLabelsAmount(float a) {
        labelsAmount=a;
        StelApp::getInstance().addNetworkCommand("StarMgr.setLabelsAmount("+QString("%0").arg(a)+");");
    }
    ...
    void setFlagMagLevel(bool b);
    bool getFlagMagLevel() const;

    void setlimitMagValue(double val) { limitMagValue = val;}
    double getlimitMagValue() { return limitMagValue;}

    bool getTrailFader() { return trailFader;}

    void setFlagSelectedLabel(bool b) {
        flagSelectedLabel = b;
        StelApp::getInstance().addNetworkCommand("StarMgr.setFlagSelectedLabel("+QString("%0").arg(b)+");");
    }
    bool getFlagSelectedLabel() const { return flagSelectedLabel; }
public:
    ///////////////////////////////////////////////////////////////////////////
    // Other methods
    ...
    class TrailGroup* getStarTrails() { return allTrails;}

    static StarMgr& getInstance() {Q_ASSERT(singleton); return *singleton;}
private:
    ...
    void drawPointer(StelPainter& sPainter, const StelNavigator * nav, const float *rcmag_table);
    ...
    bool flagMagLevel;
    double limitMagValue;

    void recreateTrails();

    bool flagSelectedLabel;

    static StarMgr* singleton;
};
