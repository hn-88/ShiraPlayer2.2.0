...
StelObjectP Star1::createStelObject(const SpecialZoneArray<Star1> *a,
    ...
    StelObjectP obj = StelObjectP(new StarWrapper1(a,z,this), true);
...
StelObjectP Star2::createStelObject(const SpecialZoneArray<Star2> *a,
    ...
    StelObjectP obj = StelObjectP(new StarWrapper2(a,z,this), true);
    obj->mag = this->mag;
    obj->bV = this->bV;
    return obj;
}
...
StelObjectP Star3::createStelObject(const SpecialZoneArray<Star3> *a,
    ...
    StelObjectP obj = StelObjectP(new StarWrapper3(a,z,this), true);
    obj->mag = this->mag;
    obj->bV = this->bV;
    return obj;
}
