...
void StelMainScriptAPI::clear(const QString& state)
{
    ...
    if (state.toLower() == "natural")
    {
        ...
        movmgr->setMountMode(StelMovementMgr::MountAltAzimuthal); // ASAF bu satýrlar planetaryum için iptal edilmek zorunda
        //#endif
    ...
    {
        //#ifdef SHIRAPLAYER_PRE
        movmgr->setMountMode(StelMovementMgr::MountEquinoxEquatorial);// ASAF bu satýrlar planetaryum için iptal edilmek zorunda
        //#endif
